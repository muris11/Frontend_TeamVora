...
export function AdminHeader() {
  ...
  const { user, impersonator, originalToken, setAuth, setImpersonator, setOriginalToken, logout } = useAuthStore();
    ...
    <>
      ...
      <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-border/50 bg-background/80 px-4 glass">
        ...
        <div className="ml-auto flex items-center gap-2">
          <div className="hidden sm:flex items-center gap-1.5 rounded-lg bg-amber-500/10 px-2.5 py-1">
            <Shield className="h-3 w-3 text-amber-600" />
            <span className="text-[11px] font-medium text-amber-700 dark:text-amber-400">Platform Admin</span>
          </div>
