            ...
            <CardContent>
              <div className="border rounded-xl overflow-hidden bg-background">
                <div className="px-6 py-8 border-b border-border/50 text-center bg-muted/10">
                  <h1 className="text-2xl font-bold tracking-tight mb-2">Syarat & Ketentuan</h1>
                  <p className="text-xs text-muted-foreground">Terakhir diperbarui: {termsContent.last_updated || "..."}</p>
                </div>
                <div className="px-6 py-6 space-y-8">
                  ...
                  {termsContent.contact_email && (
                    <div className="mt-8 pt-6 border-t border-border/50 text-sm">
                      Jika Anda memiliki pertanyaan, hubungi kami di <a href={`mailto:${termsContent.contact_email}`} className="text-primary hover:underline">{termsContent.contact_email}</a>.
                    </div>
                  )}
                </div>
              </div>
